...
module ModecPay
    ...
    @@seller_account_name='maowei@iotps.com'
      ...
      self.private_key = @@private_key
			...
			self.method = 'get'
			self.charset ='utf-8'
      self.action ='http://ceshi.allinpay.com/mobilepayment/mobile/SaveMchtOrderServlet.action'
      #self.action='：https://service.allinpay.com/mobilepayment/mobile/SaveMchtOrderServlet.action'
